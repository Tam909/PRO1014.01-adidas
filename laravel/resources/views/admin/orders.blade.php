                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                        data-bs-target="#modalOrder{{ $order->id_order }}">
                                        <i class="bi bi-eye"></i> Xem
                                    </button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="modalOrder{{ $order->id_order }}" tabindex="-1"
                                        aria-labelledby="modalLabel{{ $order->id_order }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-2"><strong>👤 Khách hàng:</strong> {{ $order->name }}
                                                    </div>
                                                    <div class="mb-2"><strong>📍 Địa chỉ:</strong>
                                                        {{ $order->shipping_address }}</div>
                                                    <div class="mb-3"><strong>📞 Số điện thoại:</strong>
                                                        {{ $order->tel }}</div>
                                                    <hr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <small class="text-muted">Size:
                                                                            {{ $item->size->name ?? 'N/A' }} | Màu:
                                                                            {{ $item->color->name ?? 'N/A' }}</small>
                                                                    </td>
                                                                    <td>{{ $item->quantity }}</td>
